...
export const useLedgerStore = defineStore('ledger', () => {
  ...
  const updateLedger = function(Ledger){
    axios.put(REST_LEDGER_API, Ledger)
  ...
  return{ ledgerList, ledgerOne, registLedger, selectLedgerAll, selectLedgerOne, updateLedger, deleteLedger, selectLedgerIncome, selectLedgerExpenditure }
